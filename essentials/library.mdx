...
- Instead of manual uploads, files can also be automatically shared via the SharePoint integration. Click on the `Connect to SharePoint` button at the top right to integrate existing files into your Sweetspot Library. 
...
- **Adding a New Excerpt**: By clicking on the `+ New` button, an option to create an excerpt will appear. Here, users can enter the name and content of the new excerpt in the text feild.
