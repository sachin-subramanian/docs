...
- **View Library**: Add additional files from your Library for the AI to use by clicking on the `View Library` button at the top of the chat. ![OC Files](/images/ocfiles.png)
