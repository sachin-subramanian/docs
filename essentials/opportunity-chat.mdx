...
- **Keyword Search**: Use `cmd + f` to quickly find keywords within the currently opened solicitation file. Or, click on the magnifying glass on the left-hand side of the file viewer toolbar (located at the bottom of the page) to toggle the search interface.![OC Search](/images/ocsearch.png)
...
- **File Management**: Navigate through the solicitation files by clicking on the file selector dropdown at the top of the file viewer. ![OC Files](/images/ocfiles.png)
