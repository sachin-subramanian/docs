...
3. Click on the citations in square brackets to view the information source.
4. Follow up on generated content as if it is a conversational interface.
5. **Copy**: Select the clipboard icon to copy the response.![OC Copy](/images/occopy.png)
6. **View Reasoning:** Sweetspot AI thinks before it responds, ensuring you get accurate information. Hover over the knowledge icon to view the reasoning provided for each message in your chat thread.![OC Reasoning](/images/ocreasoning.png)
