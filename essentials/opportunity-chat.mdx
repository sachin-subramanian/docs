...
- **Knowledge/Reasoning**: Sweetspot AI thinks before it responds, ensuring you get accurate information. HClick on ` See thought process` before each response to view the reasoning provided for each message in your chat thread.
