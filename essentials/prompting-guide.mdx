...
### Useful Prompts 
- Combine pursuit files on bridge construction with a web search for the latest federal regulations on infrastructure
- Use the internet to find the most recent standards for software development in government contracting
- Display the evaluation criteria from section M of the latest infrastructure development solicitations. 
