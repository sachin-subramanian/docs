...
1. Generate a dynamic outline by selecting the `Custom Outline` option in the `+ New` button.
...
### How to Use AI Edit
1. Highlight and right click on target text and click the `Generate` button to open the Sweetspot AI edit tool options. 
2. Let Sweetspot AI generate the passage, or provide additional input. Provide clear, concise instructions in the text box. Here are some examples:
