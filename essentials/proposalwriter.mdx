...
<Info> You can automatically generate tasks that tagged to each compliance item or specific documents within the opportunity that can be assigned to members of your organization</Info> 
...
- **Accept** Click the green checkmark icon, to accept content directly into the document. 
- **Reject** Click the red cross icon to delete or reject content from being incorporated directly into the document. 
- **Follow Up** If you are not satisfied with the generated response or want to edit it, simply re-enter a prompt and a new response will be generated. 
