...
- Populate each section by drafting content or leveraging the AI suggested content
...
## AI Edit
AI edit allows users to input specific instructions, and generate, modify, or reorganize content accordingly with AI. 
...
### How to Use AI Edit
1. Click on the AI Edit interface within your document management platform.
...
5. The AI will process your request and produce the desired output, which you can then review and incorporate into your document.
