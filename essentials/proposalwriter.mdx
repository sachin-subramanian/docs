...
3. Choose your starting point:
   ...
   - **Outline Builder**: Use the AI to construct a dynamic outline based on your pursuit files ![PR Outline](/images/pr-outline.png)
...
- Customize the outline by adding, arranging, or removing sections. ![PR Sections](/images/pr-sections.png)
- Each section includes instructions on what Sweetspot AI should generate:
1. Populate each section by creating instructions for what Sweetspot AI should generate. ![PR Section](/images/pr-section.png)
2. Leverage Sweetspot AI to create suggested instructions. 
![PR Compliance](/images/pr-compliance.png)
...
![PR Matrix](/images/pr-matrix.png)
