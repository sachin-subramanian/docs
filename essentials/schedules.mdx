...
Your search criteria will be saved, and you will receive automated search results in your inbox at the chosen interval.
...
### Understanding Schedule Results
The search results from your schedules will be sent to your inbox based on the selected interval. Each result will include opportuntiies pertinent to your query and additional information, such as NAICS codes, PSC codes, and Set Aside codes, along with the buyer`s details.
