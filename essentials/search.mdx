...
- **Ask Sweetspot AI**: Use this feature to use AI to interactively chat with documents, information, and other material provided in displayed opportunities. 
- **Create Pursuit**: Click this button to start the process of pursuing an opportunity into an organized dashboard. 
- **Connect to Salesforce**: Integrate your existing account with Salesforce to ensure all opportunities are saved across platforms. 
- **Begin Response**: Generate a proposal for the opportunitity, using Sweetspot AI and your existing Library data. 
- **Find Similar**: Automatically search for opportunities that are related to the current search. Sweetspot uses semantic search to find all relevant opportunities. 
