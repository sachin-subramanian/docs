...
Here, you can manage all aspects of the pursuit such as creating tasks and assigning them to teammates, viewing recent activity, viewing the pursuit files, checking compliance items, and responding to the actual pursuit. 

On the overview page, go ahead and click the + button next to My Tasks and create your first task. Once finished, head over to the tasks tab to view the task card. Click the arrow button at the top right of the card in order to view the full task info. You can use this section to comment on progress and collaborate with teammates over the pursuit lifecycle.
