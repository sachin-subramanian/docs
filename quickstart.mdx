---
title: 'Quickstart'
description: 'Supercharge your capture process in 6 simple steps.'
---
...
Click the menu icon on the top left and select the pursuits button. Next, click the name of the pursuit you just added. 
