...
![Inviting Teammates](/images/orgprofile.jpeg)
...
Click the menu icon and navigate towards the profile button. Here, you can input information about your organization such as a description, NAICS Code(s), PSC Code(s), and any relevant files.
